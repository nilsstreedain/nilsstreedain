...
### 🔭 I’m currently working on...
- 🧑🏻‍💻 My newest project is [duo-workaround](https://github.com/nilsstreedain/duo-bypass). duo-bypass is a web & CLI tool used to generate valid HOTP codes using 3rd party and open source applications other than DUO Mobile for organizations using by DUO Security.
